...
actual_commuters_subset_histogram <- ggplot(data = actual_commuters_subset, 
  ...
  geom_histogram(bins = 40, boundary = 0, fill = "dodgerblue", color = "white") + 
  labs(x = "Commute Time in Minutes", y = "Individual Commuters", title = "Commute Time Distribution in 2024 ACS Sample", caption = "Subset Sample Only Included Actual Commuters") + 
